...
public class MediaPlayerService extends Service {
    ...
    private static final int BACK_PENDING_REQUESTS = 1027;
...
//        PendingIntent delPendingIntent = PendingIntent.getService(this, DELETE_PENDING_REQUESTS, delIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        views.setOnClickPendingIntent(R.id.iv_next, nextPendingIntent);
         Intent intentBack = new Intent(ACTION_PREVIOUS);
        PendingIntent backPendingIntent = PendingIntent.getBroadcast(this,BACK_PENDING_REQUESTS , intentBack, PendingIntent.FLAG_CANCEL_CURRENT);
        views.setOnClickPendingIntent(R.id.iv_back, backPendingIntent);
